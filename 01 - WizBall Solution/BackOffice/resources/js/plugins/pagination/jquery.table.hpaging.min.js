        ...
        b.widget("blk.hpaging", {
            ...
            setPages: function (a) {
                ...
                if (this.clearPages()) {
                    ...
                    this._setPage(d, 1, "First");
                    this._setPage(d, "P-1", "Previous");
                    ...
                    this._setPage(d, "P+1", "Next");
                    this._setPage(d, e, "Last");
            ...
            _selectActivePage: function () {
                ...
                b(this.options.navBar).find("a").each(function () {
                    var c = b(this).text();
                    b(this).data("page") == a && "First" != c && "Last" != c && (b(this).attr("class", "active btn btn-primary"), b(this).siblings().attr("class", ""))
                })
            },
