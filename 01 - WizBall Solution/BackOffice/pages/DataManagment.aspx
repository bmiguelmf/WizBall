    ...
    <div id="st-container" class="st-container st-effect-1">
        ...
        <div class="st-menu st-effect-1" id="menu-1">
            <form class="row form-horizontal" id="form_edit_user" name="form_edit_user" method="post">
                ...
                <div class="col-lg-12">
                    <h4 style="padding-left: 4%;">Edit resource</h4>
                </div>
                <div class="col-lg-3">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="content table-full-width" style="position: relative;">
                                <table id="users_table1" class="table table-hover">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody id="users_table_body1" class="data-scroll">
                                    </tbody>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="content table-full-width" style="position: relative;">
                                <table id="users_table2" class="table table-hover">
                                    ...
                                    <tbody id="users_table_body2" class="data-scroll">
                                    </tbody>
