...
<asp:Content ID="Content2" ContentPlaceHolderID="masterViewContentBody" runat="server">
    <div class="form-body">
        ...
        <h2 class="text-center"><i>WizBall</i> Project</h2>

        <p><i>Ricardo Batista</i> was using a non-practical and non-automated system to generate the tips for the matches.
