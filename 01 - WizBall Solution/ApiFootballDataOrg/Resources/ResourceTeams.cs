...
namespace ApiFootballDataOrg.Resources
{
    public class ResourceTeams : Resource
    {
        ...
        {
            string endPoint = GetEndPoint(Globals.URL_TEAMS, TeamId);                                           // Generate the end point.
        ...
        {
            string endPoint = GetEndPoint(Globals.URL_COMPETITIONS, CompetitionId, "teams");                    // Generate the end point.
