...
var headerCellOutcome           = document.getElementById("header-cell-outcome");
...
var outcomeSortingArrow         = headerCellOutcome.querySelector("I");
...
headerCellCompetitions.addEventListener("click", function () {
    ...
    outcomeSortingArrow.style.color         = "transparent";
...
headerCellOutcome.addEventListener("click", function () {
    ...
    dateSortingArrow.style.color            = "transparent";                        // Sets header-cell-competitions to transparent. 
    FtotahgSortingArrow.style.color         = "transparent";                        // Sets header-cell-ftotahg arrow to transparent.    
    outcomeSortingArrow.style.color         = "#9acd32";
    CompetitionsSortingArrow.style.color    = "transparent";                        // Sets header-cell-competitions arrow to transparent.


    outcomeSortingArrow.classList.toggle("fa-long-arrow-alt-up");                   // Toggles sorting icon.
    outcomeSortingArrow.classList.toggle("fa-long-arrow-alt-down");


    if (outcomeSorting === "desc")                                                  // Sorts columns accordingly.
    {
        sortOutcomeAsc();
        outcomeSorting = "asc";
    }
    else if (outcomeSorting === "asc") {
...
// ----------------------------------------------------------------------------------------------------------------
// --- Change grid columns based on width                                                                
// ----------------------------------------------------------------------------------------------------------------
window.addEventListener("resize", setColumnsHeaderText);
function setColumnsHeaderText() {
    if (window.innerWidth < 960)
        document.querySelector("#grid-header div:nth-child(5)").innerHTML = "";
    else
        document.querySelector("#grid-header div:nth-child(5)").innerHTML = "Score";
}
